...
vn-serve browser UI
  ...
  -> host-worker
       text lane  -> WebGPT MCP webgpt_research -> Singulari connector tools
...
| --- | --- | --- | --- | --- |
| Text | `webgpt_research` + `worldsim_next_turn_form` / `worldsim_submit_turn_form` connector calls | `9238` | `~/.hesperides/singulari-world/webgpt/text-profile` | `agent_bridge/webgpt_conversation_binding.json` |
