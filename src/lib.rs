...
pub use encounter_surface::{
    ...
    EncounterConstraintKind, EncounterPersistence, EncounterPhysicalAnchor,
    EncounterPhysicalAnchorKind, EncounterProposal, EncounterSalience, EncounterSurface,
    EncounterSurfaceChange, EncounterSurfaceClosure, EncounterSurfaceEventPlan,
...
pub use knowledge_ledger::{
    ...
    KnowledgeClaimEventInput, KnowledgeConflict, KnowledgeConflictKind, KnowledgeEventKind,
    KnowledgeEventRecord, KnowledgeHolderKind, KnowledgeHolderSnapshot, KnowledgeLedgerState,
